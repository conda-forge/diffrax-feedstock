...
Once the `conda-forge` channel has been enabled, `diffrax` can be installed with:

```
conda install diffrax
```

It is possible to list all of the versions of `diffrax` available on your platform with:
